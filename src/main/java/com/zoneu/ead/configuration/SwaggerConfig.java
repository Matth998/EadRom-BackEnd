package com.zoneu.ead.configuration;
...
public class SwaggerConfig {
	...
	public OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info()
					.title("Academia Rommanel")
					.description("Project Ead Rommanel - Test")
					.version("v1.0.0")
				.license(new License()
					.name("https://mathsilva.netlify.app")
					.url("http://springdoc.org"))
				.contact(new Contact()
					.name("Matheus Silva")
					.url("https://github.com/Matth998/Ead")
